...
<html><head>
		...
		<meta name="keywords" content="新手理财|新手独享|散标|新手指引|新手任务| WE|we理财|we财富官网|we理财产品|Wealth Evolution|人人贷理财|APP" />
		<meta name="description" content="WE(Wealth Evolution)官网-中国互联网百强企业旗下3A级理财平台，为广大理财用户提供更多元的投资选择与更优质的综合理财服务。投资理财用户可通过新手专区进行散标投资获得稳定收益。" />
		<title>新手专区-人人贷WE理财(Wealth Evolution)-中国互联网百强企业旗下3A级理财平台</title>
    ...
    <link rel="stylesheet" type="text/css" href="/TP/one/Public/css/common_widget_a1e249e.css" /><link rel="stylesheet" type="text/css" href="/TP/one/Public/css/invest_widget_5739d14.css" /><link rel="stylesheet" type="text/css" href="/TP/one/Public/css/region_dbcd80c.css" /></head>
    <body class="body">
        <script>
...
<div id="newbee-region-banner-con">
    
<div class="wdg-newbee-nav">
	<div class="main-section">
		<ul class="account-menu fn-clear">
			<li class="active" ><a href="/newComerLoan">新手专区</a></li>
			<li class=""><a href="/guide">新手指引</a></li>
			<li class=""><a href="/event/newTask">新手任务</a></li>
		</ul>
	</div>
	<div class="nav-bg"></div>
</div>
    <div class="main-section content-wrap">
        <a href="/guide" class="j-btn j-btn-orange">了解更多</a>
    </div>
</div>
			
			
<div class="main-section page-section   newbee-region-page ">
  ...
  <div class="container_12_1080"  id="loadListRecommand">
  	<div class="ui-box-white-bg">
       
        <div class="card-detail" >
            <div class="card-detail-tag"></div>
            <ul class="card-detail-head fn-clear">
                <li class="card-detail-head-01 fn-left">U计划-新160607期</li>
                <li class="card-detail-head-02 fn-right">*甄选精品限量发布 新人仅可购买一次</li>
            </ul>
            <div class="card-detail-item fn-clear">
                ...
                <div class="card-detail-item-right fn-left">
                    ...
                    <p class="button-text">精选短期 收益更佳</p>
                </div>
            </div>
        </div>
  ...
  <div class="loan-list-main">
        <div class="loan-list-head"> </div>
  ...
  <div class="container_12_1080" >
  	<div class="ui-box-white-bg">
	   ...
	   <ul class="ui-list ui-list-m   ui-list-invest" id="plan-list"></ul>
       <ul class="newbee-loan-notice pd-horizon ">
            <li>新手专享项目仅限于未投资过P2P产品的用户</li>
       </ul>
	   <div class="mt10 mb10 pagination-box fn-clear" id="plan-list-pagination"></div>   
	   		
    </div>
  </div>
<script id="plan-list-template" type="text/x-handlebars-template">
	<table  style="width:100%">
            <thead>
                <tr class="ui-list-header">
                    <th  width="186px" class="ui-list-title text-left"><span  class="text  pl25">计划名称</span></th>
                    ...
                    <th  width="166" class="ui-list-title text-right"><span class="text pr25">状态</span></th>
                </tr>
            </thead>
            <tbody>
                 {{# each plans }}
                    <tr class="{{itemStyle}} ui-list-item">
                        <td class="text-left">
                        <div class="ui-list-field ui-td-bg pl25 w160 fn-text-overflow">
                        ...
                        <td class="text-right">
                        <div class="ui-list-field ui-td-bg pr10 color-orange-text">
                            {{expectedYearRate}}
                        </div>
                        </td>
                        <td class="text-right ">
                        ...
                        <td class="text-right">
                        <div class="ui-list-field ui-td-bg pr25">
                            {{# if alink }}
...
<script id="plan-list-rsp" type="text/x-json">[com.renrendai.vo.PriorFinancePlanVo@72fe4854, com.renrendai.vo.PriorFinancePlanVo@143ebdc7, com.renrendai.vo.PriorFinancePlanVo@231d5e33, com.renrendai.vo.PriorFinancePlanVo@5d137847, com.renrendai.vo.PriorFinancePlanVo@293dad0e]</script>
  </div>
