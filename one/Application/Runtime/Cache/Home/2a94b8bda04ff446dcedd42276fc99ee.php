...
<html><head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="/07c/one/Public/static/common/img/favicon.ico" />
        <link rel="stylesheet" type="text/css" href="/07c/one/Public/css/base_ac0da34.css">
        <!--header中的css-->
        
        
        <link rel="stylesheet" href="/07c/one/Public/css/video-js_f377876.css"/>
        ...
        <script src="/07c/one/Public/js/vendors_8a6040f.js"></script>
        <!--header中的js-->
        
        <!-- If you'd like to support IE8 -->
        
        
        <script src="/07c/one/Public/js/video_41dc322.js"></script>
    
        <script>
            weLogger.init({ platform : 'pc' });
            weLogger.perf.headStart( _jHeadStart );
        </script>
    <link rel="stylesheet" type="text/css" href="/07c/one/Public/css/common_widget_a1e249e.css" /><link rel="stylesheet" type="text/css" href="/07c/one/Public/css/invest_widget_5739d14.css" /><link rel="stylesheet" type="text/css" href="/07c/one/Public/css/index_358777c.css" /><link rel="stylesheet" type="text/css" href="/07c/one/Public/css/home_widget_9fe32bd.css" /></head>
    <body class="body">
        <script>
...
<div class="wdg-second-header">
    <div class="main-section">
        ...
        <ul class="site-nav">
            ...
            <li class="channel-item"><a href="/07c/one/index.php/home/index">首页</a></li>
            <li class="channel-item"><a href="/07c/one/index.php/home/index/jijin">基金</a></li>
            <li class="channel-item"><a href="/07c/one/index.php/home/index/ujihua">U计划</a></li>
            <li class="channel-item"><a href="/07c/one/index.php/home/index/xinjihua">薪计划</a></li>
            
            
            <li class="channel-item"><a href="/07c/one/index.php/home/index/zq">债权</a></li>
            <li class="channel-item"><a href="/07c/one/index.php/home/index/xinshou">新手专区</a></li>
...
<div class="fn-hide">
  ...
  <div id="weixin" class="p20 text-center">
    ...
    <img src="/07c/one/Public/images/weixin_l.jpg" />
  ...
  <ul class="ui-footer-links fn-left friendlink">
    ...
    <div class="ui-footer-section ui-footer-links second">
      ...
      <div class="weixin fn-clear">
        <dl class="fn-left">
          <dd><img src="/07c/one/Public/images/we-weixing_334069c.png" alt=""></dd>
          <dt>关注微信账号</dt>
        </dl>
        <dl class="fn-left app-down">
          <dd><img src="/07c/one/Public/images/app-weixin_32107fa.png" alt=""></dd>
          <dt>下载手机app</dt>
        </dl>
      </div>
    </div>
...
<div class="fn-hide">
  <div id="weixin-content" class="p20 text-center">
    <img src="/07c/one/Public/images/weixin_l.jpg" style="width:250px" />
...
<div class="ui-message-content j-result-dialog">
  ...
  <div class="ui-message-operation text-center">
    ...
    <script type="text/javascript" src="/07c/one/Public/js/require_2f19223.js"></script><script type="text/javascript" src="/07c/one/Public/js/common_widget_78d2def.js"></script><script type="text/javascript" src="/07c/one/Public/js/index_b397526.js"></script><script type="text/javascript">;require(["common:widget/second-header/second-header"], function(header){
        header.init();
    });
